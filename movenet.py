...
# Code modified from the Movenet website: https://www.tensorflow.org/hub/tutorials/movenet
# Portions of this file are modifications based on work created and shared by Google and used according to terms described in the Apache 2.0 License.
...
# pip install -q imageio opencv-python-headless git+https://github.com/tensorflow/docs tensorflow tensorflow_hub numpy matplotlib imageio IPython

# Parameters
# use movenet_lightning for speed or movenet_thunder for accuracy
...
import numpy as np
import cv2
import os # to get the different movenet libraries
...
if "tflite" in model_name:
  ...
  # CHANGED - the model is now downloaded as is in the folder, with the lightning_f16 model
  input_size = 192
...
# Run inference on image and return data
